...
//  Modify by Rockgarden on 2016/12/18
...
public var rockNoModeButton = false
...
public final class FusumaViewController: UIViewController {
    ...
    public var hasLibrary = true
    public var hasCamera = true

    public var initMode: FusumaMode = .camera
...
extension FusumaViewController: FSAlbumViewDelegate, FSCameraViewDelegate, FSVideoCameraViewDelegate {
    ...
    func showError(_ message: Any) {
        let m = message as! String
        let alert = UIAlertController(title: "Error Info", message: m, preferredStyle: .alert)
...
private extension FusumaViewController {
    ...
    func initModeNoButton(_ mode: FusumaMode) {
        libraryButton.removeFromSuperview()
        cameraButton.removeFromSuperview()
    ...
    func highlightButton(_ button: UIButton) {
        ...
        button.addBottomBorder(fusumaTintColor, width: 2)
    }
}
