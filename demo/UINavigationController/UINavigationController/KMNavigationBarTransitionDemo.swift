//
//  KMNavigationBarTransitionDemo.swift
...
class KMNavigationBarTransitionDemo: UITableViewController {
...
extension KMNavigationBarTransitionDemo {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let identifier = segue.identifier {
            ...
            case Constants.Segue.ShowNextIdentifier:
                guard let viewController = segue.destination as? KMNavigationBarTransitionDemo else {
                    return
                }
