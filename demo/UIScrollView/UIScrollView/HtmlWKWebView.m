...
//  UIScrollView
//
//  Created by wangkan on 2017/11/9.
...
- (void)webView:(WKWebView *)webView didFinishNavigation:(WKNavigation *)navigation{
    ...
    [webView evaluateJavaScript:@"document.body.offsetHeight;" completionHandler:^(id Result, NSError * error) {
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            _footView.frame = CGRectMake(0, documentHeight-self.footView.frame.size.height, UIScreen.mainScreen.bounds.size.width, self.footView.frame.size.height);
            //加载完设置好坐标打开
            _footView.hidden = NO;
