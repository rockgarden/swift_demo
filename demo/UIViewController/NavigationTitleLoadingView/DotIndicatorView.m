...
@property (nonatomic, assign) DotIndicatorViewStyle dotStyle;
...
- (UIBezierPath *)createDotPath
{
    ...
    if (_dotStyle == DotIndicatorViewStyleSquare)
    {
        cornerRadius = 0.0f;
    }
    else if (_dotStyle == DotIndicatorViewStyleRound)
    {
        cornerRadius = 2;
    }
    else if (_dotStyle == DotIndicatorViewStyleCircle)
    {
