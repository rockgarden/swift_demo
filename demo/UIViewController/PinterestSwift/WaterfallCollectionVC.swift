...
class WaterfallCollectionVC: UICollectionViewController,CHTCollectionViewDelegateWaterfallLayout, NTTransitionProtocol, NTWaterFallViewControllerProtocol{
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAtIndexPath indexPath: IndexPath) -> CGSize{
        let image = UIImage(named: self.imageNameList[indexPath.row] as String)!
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell{
        ...
        collectionCell.imageName = imageNameList[indexPath.row] as String
    ...
    func viewWillAppearWithPageIndex(_ pageIndex: NSInteger) {
        ...
        let image = UIImage(named: imageNameList[pageIndex])!
        let imageHeight = image.size.height*gridWidth/image.size.width
