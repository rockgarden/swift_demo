...
class ModelController: NSObject {
    ...
    var recentAlbums : PHFetchResult<PHAssetCollection>! //AnyObject -> PHAssetCollection
    var photos : PHFetchResult<PHAsset>! //AnyObject -> PHAsset
    
    func tryToGetStarted() {
        self.recentAlbums = PHAssetCollection.fetchAssetCollections(
        ...
        let pred = NSPredicate(format: "mediaType = %@", NSNumber(value: PHAssetMediaType.image.rawValue as Int))
