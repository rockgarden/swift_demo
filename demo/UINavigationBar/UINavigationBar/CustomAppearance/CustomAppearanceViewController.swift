...
class CustomAppearanceViewController: UITableViewController {
    ...
    func applyImageBackgroundToTheNavigationBar() {
        ...
        // are empty.
        backgroundImageForDefaultBarMetrics = backgroundImageForDefaultBarMetrics.resizableImage(withCapInsets: UIEdgeInsets(top: 0, left: 0, bottom: backgroundImageForDefaultBarMetrics.size.height - 1, right: backgroundImageForDefaultBarMetrics.size.width - 1))
        backgroundImageForLandscapePhoneBarMetrics = backgroundImageForLandscapePhoneBarMetrics.resizableImage(withCapInsets: UIEdgeInsets(top: 0, left: 0, bottom: backgroundImageForLandscapePhoneBarMetrics.size.height - 1, right: backgroundImageForLandscapePhoneBarMetrics.size.width - 1))
    ...
    func applyBarTintColorToTheNavigationBar() {
        ...
        let barTintColor = UIColor(colorLiteralRed: 176.0/255.0, green: 226.0/255.0, blue: 172.0/255.0, alpha: 1)
        let darkendBarTintColor = UIColor(colorLiteralRed: 176.0/255.0 - 0.05, green: 226.0/255.0 - 0.02, blue: 172.0/255.0 - 0.05, alpha: 1)
