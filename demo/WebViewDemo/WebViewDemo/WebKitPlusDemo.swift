...
class WebKitPlusDemo: ZenWebViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationController?.barHideOnSwipeGestureRecognizer.addTarget(self, action: #selector(self.updateStatusBar(_:)))
    ...
    @objc func updateStatusBar(_: AnyObject?) {
...
extension WebKitPlusDemo: WKNavigationDelegate {
