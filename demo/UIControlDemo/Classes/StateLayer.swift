...
class StateLayer: CAShapeLayer {
    var stateDelegate: StateLayerDelegate?
    ...
    convenience init(frame:CGRect,delegate:StateLayerDelegate){
        self.init()
...
extension StateLayer: CAAnimationDelegate {
